...
# Script được cập nhật từ Admin Panel
...
sed -i '' 's|src="assets/images/roll-cake-hero.jpg"|src="https://lambanhngon.com/news_pictures/syi1572881573.jpg"|g' banh-bong-lan-cuon.html
...
echo "Đã thay thế tất cả hình ảnh!"
